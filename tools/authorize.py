#!/usr/bin/env python3
"""Authorize an OstojaOS Cloud Sync account on a computer with a browser."""
import argparse
import json
import os
...
print('Your browser will open. Sign in to the account you want to connect to OstojaOS.')
...
output = args.output or Path('ostojaos-' + args.provider + '-account.json')
try:
