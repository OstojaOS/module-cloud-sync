# OstojaOS Cloud Sync module

Synchronize local folders with multiple Google Drive and Dropbox accounts.

Standalone source repository. Requires OstojaOS core `>=0.2.1,<0.3.0`, module API 1.
